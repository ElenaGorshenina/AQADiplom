...
25.1 В поле "Владелец" ввести нболее 21 буквы. Остальные поля заполнить валидными данным;

25.2 Клик по кнопке "Продолжить".

*Ожидаемый результат:*

25.1 В поле "Владелец" отображается 2 цифры, остальные поля заполнены валидными данными;
